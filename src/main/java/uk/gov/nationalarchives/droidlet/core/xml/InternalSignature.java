...
public class InternalSignature extends SimpleElement
{
	...
	//	{
	//		/*
	//		 * Assign a sort order on the basis of what kinds of byte sequences
	//		 * appear in the signature: This is currently defined as follows, where:
	//		 *
	...
	//	/**
	//	 *
	//	 * @return A list of regular expressions for each byte sequence in this
	//	 *         signature.
	//	 */
