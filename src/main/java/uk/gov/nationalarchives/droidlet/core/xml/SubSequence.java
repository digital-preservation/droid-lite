...
public class SubSequence extends SimpleElement
{
	...
	//	 *
	//	 * @param anchor
	//	 *            The SequenceMatcher which is used to search for the
	//	 *            subsequence.
	//	 * @param leftFragments
	//	 *            fragments to add to the left of the subsequence.
	//	 * @param rightFragments
	//	 *            fragments to add to the right of the subsequence.
	//	 * @param minSeqOffset
	//	 *            The minimum offset to begin looking for this subsequence.
	//	 * @param maxSeqOffset
	//	 *            The maximum offset to find this subsequence.
	//	 */
	//	public SubSequence(final SequenceMatcher anchor, final List<List<SideFragment>> leftFragments, final List<List<SideFragment>> rightFragments, final int minSeqOffset, final int maxSeqOffset)
	//	{
	//		this.matcher = anchor;
	...
	//	 * @param theShift
	//	 *            Not used - preserved for backwards compatibility.
	//	 */
	//	@Deprecated
	...
	//	 *
	//	 * @param seq
	//	 *            A regular expression defining the anchor sequence for the
	//	 *            subsequence.
	//	 */
	...
	//
	//	/**
	//	 * Needed so the XML parser has a method to call when it encounters this
	//	 * information in the XML file, but the information is no longer required.
	//	 *
	...
	//	 * @param value
	//	 *            Value of attribute to set (may be ignored)
	//	 */
	//	@Override
	...
	//		}
	//		else
	//			if ("SubSeqMaxOffset".equals(name))
	//			{
	//				setMaxSeqOffset(Integer.parseInt(value));
	//			}
	//			else
	//				if ("MinFragLength".equals(name))
	//				{
	...
	//	/**
	//	 * @param leftFrag
	//	 *            true to return information about the left fragments, false to
	//	 *            return information about the right fragments.
	//	 * @return the number of fragment offsetPositions for either the left or
	//	 *         right fragments.
	//	 */
	...
	//	 *            return information about the right fragments.
	//	 * @param thePosition
	//	 *            The fragment positionInFile to retrieve number of fragments
	//	 *            for.
	//	 * @return the number of alternative fragments for the given left or right
	//	 *         positionInFile.
	//	 */
	...
	//	 *            List of List of Side Fragments (inner list is to allow for
	//	 *            multiple options at positions.
	//	 * @return The number of alternative fragments at the position supplied in
	//	 *         thePosition.
	//	 */
	...
	//	 *            The index of the fragment alternative at the given left or
	//	 *            right positionInFile.
	//	 * @return The fragment alternative at the given left or right
	//	 *         positionInFile.
	//	 */
	//	public final SideFragment getFragment(final boolean leftFrag, final int thePosition, final int alternateIndex)
	//	{
	//		return leftFrag ? (SideFragment) (this.orderedLeftFragments.get(thePosition - 1)).get(alternateIndex) : (SideFragment) (this.orderedRightFragments.get(thePosition - 1)).get(alternateIndex);
	//	}
	//
	//	/**
	...
	//	/**
	//	 *
	//	 * @return the maximum offset to search up to when looking for this
	//	 *         subsequence.
	//	 */
	...
	//	 */
	//	/*
	//	 * public final int getMinFragLength() { return minFragLength; }
	//	 */
	//
	//	/**
	//	 * This method must be called after the signature file has been parsed and
	//	 * before running any file identifications.
	//	 *
	//	 * @param reverseOrder
	//	 *            Whether this subsequence is scanned forwards in the file or
	//	 *            backwards from the end of the file.
	//	 * @param fullScan
	//	 *            Whether this subsequence follows a wildcard .* sequence.
	//	 */
	...
	//
	//	/*
	//	 * Re-orders the left and right sequence fragments in increasing
	//	 * positionInFile order. Also calculates the minimum and maximum lengths a
	//	 * fragment can have.
	//	 */
	...
	//
	//	/**
	//	 * If a SubSequence was built by parsing XML, the fragments are stored in
	//	 * the leftFragments and rightFragments lists, which aren't ordered for
	//	 * searching. To search, DROID needs to re-build those lists with the
	//	 * fragments in the right order, and collapsed into lists of lists (e.g. for
	//	 * each fragment position we have a list of possible alternative matches
	//	 * (alternatives fragments, e.g. (01 02 03 | 02 04 05) matches two fragments
	//	 * at the same position.
	//	 *
	//	 * It also performs some optimisation on the fragments:
	//	 *
	//	 * 1. Turning alternatives of single bytes into sets, e.g. (01|02|03) is
	//	 * more efficiently matched as [01 02 03]. 2. Capturing some fragments back
	//	 * into the main anchor sequence, as DROID can search for some fragments
	//	 * directly.
	//	 *
	//	 * Once it has built and optimised the fragments, it builds the matcher and
	//	 * search required for actual searching.
	//	 */
	...
	//
	//	/**
	//	 * Calculates various properties of the fragments needed to search
	...
	//
	//	/**
	//	 * Processes the left fragment XML list into a
	//	 * {@code List<List<SideFragment>>}
	//	 */
	...
	//		{ // loop through fragment offsetPositions
	...
	//
	//	/**
	//	 * Processes the right fragment XML list into a
	//	 * {@code List<List<SideFragment>>}
	//	 */
	...
	//
	//	/**
	//	 * Optimise alternative sequences of single bytes into a byte-class, instead
	//	 * of being a set of alternatives. This is more efficient to match using
	//	 * byteseek.
	//	 *
	//	 * @param fragments
	//	 */
	...
	//		{ // loop through all offsetPositions:
	...
	//
	//	/**
	//	 * Find fragments on the left which could be captured back into the main
	//	 * anchor sequence:
	//	 */
	...
	//		FRAGS: for (int position = 0; position < numLeftFragmentPos; position++)
	//		{
	//			List<SideFragment> fragsAtPos = orderedLeftFragments.get(position);
	//			if (fragsAtPos.size() == 1)
	//			{ // no alternatives at this positionInFile.
	//				for (SideFragment frag : fragsAtPos)
	//				{
	//					if (frag.getMinOffset() == 0 && frag.getMaxOffset() == 0)
	//					{ // bangs right up to the main sequence
	//						subsequenceText = frag.toRegularExpression(true) + ' ' + subsequenceText;
	//						captureFragPos = position;
	//					}
	//					else
	//						if (frag.getMinOffset() == frag.getMaxOffset())
	//						{ // a fixed offset from the main sequence
	//							if (backwardsSearch)
	//							{
	//								// TODO: work out if adding would make shift
	//								// worse - it depends on this fragment
	//								// but also potentially fragments after it.
	//								break FRAGS;
	//							}
	//							else
	//							{
	//								// CHECKSTYLE:OFF " .{" and "} " defined locally
	//								// in separate methods for optimal performance
	...
	//
	//	/**
	//	 * Find fragments on the right which could be captured back into the main
	//	 * anchor sequence:
	//	 */
	...
	//						captureFragPos = position;
	//						// CHECKSTYLE:OFF Quite legitimate to have more than 120
	//						// chars per line just now...
	//					}
	//					else
	//						if (frag.getMinOffset() == frag.getMaxOffset())
	//						{ // a fixed offset from the main sequence
	//							if (backwardsSearch)
	//							{ // things on the right can't make our average
	//							  // shift worse, so just add them.
	//								subsequenceText = subsequenceText + " .{" + frag.getMinOffset() + "} " + frag.toRegularExpression(true);
	//								captureFragPos = position;
	//								// CHECKSTYLE:ON
	//							}
	//							else
	//							{ // work out if adding this would make our average
	//							  // shift worse.
	//							  // TODO: work out if adding would make shift
	//							  // worse - it depends on this fragment
	//							  // but also potentially fragments after it.
	...
	//	{
	//		// Have we have captured fragments up to this positionInFile into the
	//		// main subsequence?
	//		if (captureFragPos > -1)
	//		{
	...
	//
	//	/**
	//	 * Compiles the matcher and searcher objects to search for the main anchor
	//	 * sequence with.
	//	 */
	...
	//		try
	//		{
	//			// CHECKSTYLE:OFF Quite legitimate to have more than 120 chars per
	//			// line just now...
	...
	//		if (matcher.length() == 1)
	//		{
	//			searcher = new ByteMatcherSearcher(matcher.getMatcherForPosition(0)); // use
	//			                                                                      // simplest
	//			                                                                      // byte
	//			                                                                      // matcher
	//			                                                                      // searcher
	...
	//		else
	//		{
	//			searcher = new HorspoolFinalFlagSearcher(matcher); // use shifting
	//			                                                   // searcher if
	//			                                                   // shifts can be
	//			                                                   // bigger than
	//			                                                   // one.
	...
	//	{
	//		return checkFragmentList(orderedLeftFragments) || checkFragmentList(orderedRightFragments);
	//	}
	//
	...
	//	private String getFragmentAlternativesAsRegularExpression(final boolean prettyPrint, final int positionIndex, final List<SideFragment> fragments)
	//	{
	...
	//			if (alternateIndex > 0)
	//			{
	//				regularExpression.append("|"); // | already a good separator -
	//				                               // no need for spaces in pretty
	//				                               // printing.
	//			}
	...
	//	}
	//
	//	private void appendFragmentstoRegularExpression(final boolean prettyPrint, final StringBuffer regularExpression, final boolean expressionFirst, final int positionIndex, final List<SideFragment> fragments)
	//	{
	...
	//
	//		// If we have more than one fragment at a positionInFile, it's a list of
	//		// alternatives:
	//		String fragmentExpression;
	//		if (fragments.size() > 1)
	//		{ // Write out the fragments as a list of alternatives:
	//			fragmentExpression = getFragmentAlternativesAsRegularExpression(prettyPrint, positionIndex, fragments);
	//		}
	//		else
	//		{ // otherwise just get the fragment:
	...
	//	{
	//
	//		// For each fragment position, record whether or not the constituent
	//		// fragments include at least
	...
	//		}
	//
	//		// return orderedFragmentsList.size() > 1 &&
	//		// ArrayUtils.contains(orderedFragsHaveVariableOffset, true);
	...
	//	 *
	//	 * @param prettyPrint
	//	 *            Whether to pretty print the regular expression or not.
	...
	//			appendFragmentstoRegularExpression(prettyPrint, regularExpression, EXPRESSION_BEFORE_GAPS, positionIndex, fragments);
	//		}
	//
	...
	//			appendFragmentstoRegularExpression(prettyPrint, regularExpression, GAPS_BEFORE_EXPRESSION, positionIndex, fragments);
	//		}
	//
	//		return regularExpression.toString();
	//	}
	...
	//
	//	/**
	//	 * Uses the Boyer-Moore-Horspool search algorithm to find a sequence within
	//	 * a window on a file.
	//	 *
	//	 * The search proceeds by trying to find an "anchor" sequence of bytes in
	//	 * the file, using the Boyer-Moore-Horspool algorithm, which permits it to
	//	 * skip over bytes if they can't possibly match the anchor sequence. It
	//	 * scans from the opposite end of the sequence to the search direction. This
	//	 * means it doesn't have to check every single byte in the search window. In
	//	 * general, the longer the anchor sequence, the more bytes we can skip. When
	//	 * it finds an anchor sequence, it checks any left or right fragments that
	//	 * may surround it, to verify the match.
	//	 *
	//	 * @param position
	//	 *            The positionInFile to begin searching from.
	//	 * @param targetFile
	//	 *            The file to search in.
	//	 * @param maxBytesToScan
	//	 *            The maximum amount of bytes to read from the beginning or end
	//	 *            of the file. If negative, scanning is unlimited.
	//	 * @param bofSubsequence
	//	 *            Indicates when subsequence is anchored to BOF
	//	 * @param eofSubsequence
	//	 *            Indicates when subsequence is anchored to EOF
	...
	//	 * byte offsetPositions in the file. Either returns the last byte taken up
	//	 * by the identified sequences or returns -2 if no match was found
	//	 *
	//	 * @param bytes
	//	 *            the binary file to be identified
	//	 * @param leftBytePos
	//	 *            left-most byte positionInFile of allowed search window on file
	//	 * @param rightBytePos
	//	 *            right-most byte positionInFile of allowed search window on
	//	 *            file
	//	 * @param searchDirection
	//	 *            1 for a left to right search, -1 for right to left
	//	 * @param offsetRange
	//	 *            range of possible start offsetPositions in the direction of
	//	 *            searchDirection
	//	 * @param fragments
	//	 *            list of fragments at positions for which to check
	//	 * @param finalOffsetFoundPositions
	//	 *            Class to hold information about the file positions and offsets
	//	 *            at which the fragment(s) in the final fragment option was (or
	//	 *            were) previously found in the file. Will be null unless we're
	//	 *            rechecking the final position fragment(s) for compliance with
	//	 *            the overall sequence offset after all the fragments were found
	//	 *            with valid offsets in relation to each other in the first pass
	//	 *            check.
	//	 * @return
	//	 */
	//	// CHECKSTYLE:OFF - way, way, way too complex.
	//	private long[] bytePosForRightFragments(final WindowReader bytes, final long leftBytePos, final long rightBytePos, final int searchDirection, final int offsetRange, List<List<SideFragment>> fragments, OffsetAndFilePositions finalOffsetFoundPositions)
	//	{
	//		// CHECKSTYLE:ON
	...
	//			// this.getNumAlternativeFragments(leftFrag, iFragPos);
	...
	//
	//		// Stack to store intermediate fragment hits. Avoid the overhead of the
	//		// stack though if there's only one
	//		// fragment option and/or none of the fragment positions have variable
	//		// offsets.
	...
	//			// array to store possible end offsetPositions after this fragment
	//			// positionInFile has been examined
	...
	//				// current end offsetPositions
	//				FRAGS_AT_POSITION: for (int iAlt = 0; iAlt < numAltFrags; iAlt++)
	//				{
	//					SideFragment fragment = fragmentsAtPosition.get(iAlt);
	//
	//					// If checking for a further occurrence of a fragment found
	//					// previously, then adjust the offsets to
	//					// take account of the previous occurrence in relation to
	//					// the previous fragment position (or main
	//					// sequence). We'll need to clone the fragment in such cases
	//					// as the adjustment applies only for
	//					// the current file!
	//					long previousInstanceOffsetFoundPosition = finalOffsetFoundPositions == null || !recheckingFinalFragmentOption ? -1 : finalOffsetFoundPositions.getOffsetPosition(iAlt);
	//
	...
	//						// This will be the offset of the last byte in in the
	//						// fragment form BOF
	//						previousInstanceFilePosition = finalOffsetFoundPositions.getFilePosition(iAlt);
	//
	//						long newMaxOffset = fragment.getMaxOffset() - previousInstanceOffsetFoundPosition - (leftBytePos - (previousInstanceFilePosition - fragment.getNumBytes() + 1));
	//						long newMinOffset = fragment.getMinOffset() - previousInstanceOffsetFoundPosition - (leftBytePos - (previousInstanceFilePosition - fragment.getNumBytes() + 1));
	//
	...
	//					if (searchDirection == -1)
	//					{
	//						tempFragEnd = this.endBytePosForSeqFrag(bytes, leftBytePos, markerPos[iOption], false, searchDirection, iFragPos, fragment);
	//					}
	//					else
	//					{
	//						tempFragEnd = this.endBytePosForSeqFrag(bytes, markerPos[iOption], rightBytePos, false, searchDirection, iFragPos, fragment);
	//					}
	//
	//					if (tempFragEnd > -1)
	...
	//						numEndPos += 1;
	//
	//						// Get the offset at which the fragment was actually
	//						// found,
	//						long offSetFound = tempFragEnd - markerPos[iOption] - fragment.getNumBytes() + 1;
	//
	//						// ...and, if the current or following fragment position
	//						// has a variable offset, add to the
	//						// stack as the last successful fragment match and
	//						// current backtrack target.
	...
	//						}
	//
	//						// Record the fragment position to pass back, if we're
	//						// on the final option
	...
	//					else
	//					{
	//						// Assuming we're on the final possible fragment for
	//						// this position and none so far have matched..
	//						if (iAlt == numAltFrags - 1 && numEndPos == 0 && iOption == numOptions - 1)
	//						{
	//							// No match was found for the current fragment.
	//							// Check back through any earlier fragment
	//							// matches to see if there are any further
	//							// occurences of a fragment within its offset range,
	//							// and if so, revert to that point and resume
	//							// checking from there.
	//
	//							while (fragmentHits != null && !fragmentHits.empty())
	//							{
	//								FragmentHit lastGoodFragRef = fragmentHits.pop();
	//								// Retrieve the fragment that corresponds to the
	//								// last successful match. Create a copy
	//								// of this fragment which can then be used to
	//								// test for a further match based on a new
	//								// offset defined from the previous position. We
	//								// need to use a clone because this
	//								// class instance is used to check multiple
	//								// files on different threads and the revised
	//								// check only applies to this specific file.
	//								// Alternatively we could copy the original
	//								// list at the outset but this would potentially
	...
	//
	//								// Adjust the offsets so that we now look for a
	//								// further occurrence of the fragment
	...
	//								}
	//
	//								// Check for a further occurrence of the
	//								// fragment beyond the last match position
	//								if (searchDirection == 1)
	//								{
	//									tempFragEnd = this.endBytePosForSeqFrag(bytes, lastGoodFragRef.getPositionInFile(), rightBytePos, false, searchDirection, lastGoodFragRef.getFragmentSignaturePosition(), fragment);
	//								}
	//								else
	//								{
	//									tempFragEnd = this.endBytePosForSeqFrag(bytes, leftBytePos, lastGoodFragRef.getPositionInFile(), false, searchDirection, lastGoodFragRef.getFragmentSignaturePosition(), fragment);
	//								}
	//
	//								if (tempFragEnd > -1L)
	//								{
	//									// Add the newly found fragment instance to
	//									// the top of the stack and reset the loop
	//									// position to resume checking for further
	//									// fragments from that point.
	//									tempEndPos[numEndPos] = tempFragEnd + searchDirection;
	//									// CHECKSTYLE:OFF : Quite legitimate to
	//									// modify control variables here, as we're
	...
	//									// CHECKSTYLE:ON
	//									// Get the offset of this new instance of
	//									// the current fragment from the previous
	//									// fragment, or main sequence if this is the
	//									// first fragment.
	...
	//	 * rightmost byte offsetPositions that are given. returns the end
	//	 * positionInFile of the found sequence or -1 if it is not found
	//	 *
	//	 * @param bytes
	//	 *            The bytes being reviewed for identification
	//	 * @param leftEndBytePos
	//	 *            leftmost positionInFile in file at which to search
	...
	//	 *            -1 for right to left)
	//	 * @param fragPos
	//	 *            positionInFile of left/right sequence fragment to use
	//	 * @param fragment
	//	 *            The fragment to search for.
	//	 * @return If subSeqFound = true, an array containing the file positions of
	//	 *         each of the options found for the final fragment position. These
	//	 *         values represent the offset of the first byte of the fragment
	//	 *         from BOF. E.g. say the furthest right fragment position has only
	//	 *         one option - the 2-byte fragment BB AA, and the the file consists
	//	 *         of the following bytes: 00 00 11 22 33 44 55 00 00 FF EE 00 CC DD
	//	 *         BB AA 00 00 00 Then - Cp - the return value will be a single
	//	 *         element array with the value 14. If subSeqFound = true, new
	//	 *         long[0].
	//	 */
	//	// CHECKSTYLE:OFF too long and complex.
	//	private long endBytePosForSeqFrag(final WindowReader bytes, final long leftEndBytePos, final long rightEndBytePos, final boolean leftFrag, final int searchDirection, final int fragPos, final SideFragment fragment)
	//	{
	//		// CHECKSTYLE:ON
	//		long startPosInFile;
	...
	//			}
	//			else
	//				if (fragPos < this.getNumFragmentPositions(leftFrag))
	//				{
	...
	//				}
	//
	//		// set up start and end offsetPositions for searches taking into account
	//		// min and max offsets
	//		if (searchDirection == -1)
	//		{
	...
	//		// the end of the search area has been
	//		// reached. Compare sequence with file contents directly at fileMarker
	//		// positionInFile
	...
	//	 * the furthest left fragment position has only one option - the 2-byte
	//	 * fragment AA BB, and the the start of the file reads 00 00 AA BB CC DD
	//	 * .... Then - Cp - the return value will be a single element array with the
	//	 * value 2. If subSeqFound = true, new long[0].
	//	 */
	//	// CHECKSTYLE:OFF - way, way, way too complex.
	//	private long[] bytePosForLeftFragments(final WindowReader bytes, final long leftBytePos, final long rightBytePos, final int searchDirection, final int offsetRange, List<List<SideFragment>> fragments, OffsetAndFilePositions finalOffsetFoundPositions)
	//	{
	//		// CHECKSTYLE:ON
	//
	...
	//
	//		// Stack to store intermediate fragment hits. Avoid the overhead of the
	//		// stack though if there's
	//		// only one fragment option and/or none of the fragment positions have
	//		// variable offsets.
	//		Stack<FragmentHit> fragmentHits = null;
	...
	//		        // so for r-l left search i.e. -1, this is effectively
	//		        // iFragPos++...
	...
	//
	//					// If checking for a further occurrence of a fragment found
	//					// previously, then adjust the offsets
	//					// to take account of the previous occurrence in relation to
	//					// the previous fragment position (or main
	//					// sequence). We'll need to clone the fragment in such cases
	//					// as the adjustment applies only for
	//					// the current file!
	//					// If it's more than 1 we're not on a recheck of the final
	//					// fragment...
	//					long previousInstanceOffsetFoundPosition = finalOffsetFoundPositions == null || !recheckingFinalFragmentOption ? -1 : finalOffsetFoundPositions.getOffsetPosition(iAlt);
	//
	//					long previousInstanceFilePosition = -1;
	...
	//					if (searchDirection == 1)
	//					{
	//						tempFragEnd = this.endBytePosForSeqFrag(bytes, markerPos[iOption], rightBytePos, true, searchDirection, iFragPos, fragment);
	//					}
	//					else
	//					{
	//						// i.e. the offset of the fragment form BOF
	//						tempFragEnd = this.endBytePosForSeqFrag(bytes, leftBytePos, markerPos[iOption], true, searchDirection, iFragPos, fragment);
	//					}
	//					if (tempFragEnd > -1L)
	//					{ // a match has been found
	//						tempEndPos[numEndPos] = tempFragEnd + searchDirection;
	...
	//
	//						// Record the fragment position to pass back, if we're
	//						// on the final fragment position
	//						if (iFragPos == numFragPos)
	//						{
	//							// TODO: Long or INT. ?? Suggest longs throughout
	//							// but this involves refactoring elsewhere...
	//							if (finalOffsetFoundPositions != null)
	//							{
	//								finalOffsetFoundPositions.setPosition(iAlt, (int) offSetFound, tempFragEnd);
	//							}
	...
	//							// Check back through any earlier fragment
	//							// matches to see if there are any further
	//							// occurrences of a fragment within its
	//							// offset range, and if so, revert to that point and
	//							// resume checking from there.
	//
	//							while (fragmentHits != null && !fragmentHits.empty())
	//							{
	//
	...
	//								if (searchDirection == 1)
	//								{
	//									tempFragEnd = this.endBytePosForSeqFrag(bytes, lastGoodFragRef.getPositionInFile(), rightBytePos, true, searchDirection, lastGoodFragRef.getFragmentSignaturePosition(), fragment);
	//								}
	//								else
	//								{
	//									tempFragEnd = this.endBytePosForSeqFrag(bytes, leftBytePos, lastGoodFragRef.getPositionInFile(), true, searchDirection, lastGoodFragRef.getFragmentSignaturePosition(), fragment);
	//								}
	//
	//								if (tempFragEnd > -1L)
	//								{
	...
	//	}
	//
	//	// The following two methods exist to cater for situations where the first
	//	// (or only) left or right fragment in a
	//	// subsequence occurs more than once to the left or right of the main byte
	//	// sequence. In these cases, the initial
	//	// check will find the instance closest to the main byte sequence that meets
	//	// the fragment's own offset requirements.
	//	// However, if this instance is beyond the maximum offset for the sequence
	//	// as a whole, the whole sequence would
	//	// previously be set to not match - even though there may be further
	//	// instances of the fragment at less than or
	//	// equal to the maximum sequence offset. So we need to check for any further
	//	// occurrences to see if there is one that
	//	// occurs in the byte stream at a position at or before the allowed maximum
	//	// offset, but not less than the minimum
	//	// offset.
	//	/**
	//	 * This method is called when the furthest left fragment has been found at
	//	 * an offset which is beyond the maximum offset from BOF for the sequence as
	//	 * a whole. It checks for any further occurrences that may be positioned
	//	 * between the minimum and maximum sequence offsets.
	//	 *
	//	 * @param windowReader
	//	 *            Byteseek reader within which to search for the fragment(s)
	//	 * @param leftBytePos
	//	 *            Furthest left byte position to search
	//	 * @param rightBytePos
	//	 *            Furthest right byte position to search
	//	 * @param maxOffset
	//	 *            Maximum offset from BOF for the sequence as a whole
	//	 * @param minOffset
	//	 *            Minimum offset from BOF for the sequence as a whole
	//	 * @param leftFragOpt
	//	 *            List of one or more left fragment options, representing the
	//	 *            highest numbered left fragment position in the signature file.
	//	 * @param lastOffsetFoundPositions
	//	 *            An OffsetAndFilePositions instance containing details of the
	//	 *            offsets and file positions at which the fragment options in
	//	 *            leftFragOpt were previously found.
	//	 * @return True if no fragment occurrence found within the valid offset
	//	 *         range for the sequence. False if one or more occurrences are
	//	 *         found within the valid offset range.
	//	 */
	//	private boolean checkLeftFragmentForInvalidOffset(WindowReader windowReader, final long leftBytePos, final long rightBytePos, final long maxOffset, final long minOffset, List<List<SideFragment>> leftFragOpt, OffsetAndFilePositions lastOffsetFoundPositions)
	//	{
	//
	...
	//		do
	//		{
	//			fragmentPositions = bytePosForLeftFragments(windowReader, leftBytePos, currentRightBytePos, -1, 0, leftFragOpt, lastOffsetFoundPositions);
	...
	//
	//		// CHECKSTYLE:OFF Doesn't like parentheses but they make the code more
	//		// readable IMHO.
	...
	//
	//	/**
	//	 * This method is called when the furthest right fragment has been found at
	//	 * an offset which is beyond the maximum offset from EOF for the sequence as
	//	 * a whole. It checks for any further occurrences that may be positioned
	//	 * between the minimum and maximum sequence offsets.
	//	 *
	//	 * @param windowReader
	...
	//	 *            Furthest right byte position to search
	//	 * @param maxOffset
	//	 *            Maximum offset from EOF for the sequence as a whole
	//	 * @param minOffset
	//	 *            Minimum offset from EOF for the sequence as a whole
	//	 * @param rightFragOpt
	//	 *            List of one or more right frsagment options, representing the
	//	 *            highest numbered right fragment position in the signature
	//	 *            file.
	//	 * @param lastOffsetFoundPositions
	//	 *            An OffsetAndFilePositions instance containing details of the
	//	 *            offsets and file positions at which the fragment options in
	//	 *            rightFragOpt were previously found.
	//	 * @return True if no fragment occurrence found within the valid offset
	//	 *         range for the sequence. False if one or more occurrences are
	//	 *         found within the valid offset range.
	//	 */
	//	private boolean checkRightFragmentForInvalidOffset(WindowReader windowReader, final long leftBytePos, final long rightBytePos, final long maxOffset, final long minOffset, List<List<SideFragment>> rightFragOpt, OffsetAndFilePositions lastOffsetFoundPositions)
	//	{
	//		long[] fragmentPositions;
	...
	//		do
	//		{
	//			fragmentPositions = bytePosForRightFragments(windowReader, currentLeftBytePos, rightBytePos, 1, 0, rightFragOpt, lastOffsetFoundPositions);
	//			if (fragmentPositions.length > 0)
	//			{
	...
	//
	//	/**
	//	 * Helper class to hold history details of fragment matches found whilst
	//	 * checking a file for matches against the left and/or right fragments in a
	//	 * binary signature.
	//	 */
	...
	//		/**
	//		 *
	//		 * @param fragmentSignaturePosition
	//		 *            The index of the fragment position in the signature to
	//		 *            which the fragment hit relates. This is 1 based and
	//		 *            correlates with the "Position" attribute in the
	//		 *            RightFragment or LeftFragment element in the signature
	//		 *            file.
	//		 * @param alternativeFragmentNumber
	//		 *            The zero-base index of the fragment within the
	//		 *            {@code List<SideFragment>} in which it resides, in other
	//		 *            words the index for the fragment option for a given
	//		 *            fragment position. Usually 0 since mostly there is only
	//		 *            one alternative fragment at any given position.
	//		 * @param positionInFile
	//		 *            The position within the byte stream at which the fragment
	//		 *            was found . i.e for a left fragment the 1-based offset of
	//		 *            the first byte in the fragment from BOF, and for a right
	//		 *            fragment, the 1-based offset of the last byte in the
	//		 *            fragment from BOF. Note the use of 1 based offsets here
	//		 *            rather than the normal 0 based offsets - this corresponds
	//		 *            to the return value assigned to tempEndFrag from calls to
	//		 *            endBytePosForSeqFrag
	//		 * @param offsetFound
	//		 *            The offset at which the fragment was found, relative to
	//		 *            the previous fragment (or main sequence if
	//		 *            fragmentSignaturePosition is zero)
	//		 */
	...
	//
	//	/**
	//	 * Helper class to store information about fragments found in a byte stream.
	//	 * The class is used to store information for a given
	//	 * {@code List<SideFragment>} - which may contain one or more SideFragments
	//	 * for a given fragment position in a binary signature. The data stored
	//	 * comprises the offsets and file positions at which SideFragments within
